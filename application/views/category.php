    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                if (count($getwebsitedetailscategory)):
                    ...
                    foreach ($getwebsitedetailscategory as $row):
                        ?>
                        <div class="card mb-4">
                            <a href="#!"><img height="300" src="<?php echo base_url('uploads/files/' . $row->Upload_Image); ?>"
                                    alt="..." width="100%" /></a>
            ...
            <div class="col-lg-4">
                ...
                <!-- Side widget-->
                <div class="card mb-4">
                    <div class="card-header new-background"><i class="bi bi-newspaper me-2"></i>Recent News</div>

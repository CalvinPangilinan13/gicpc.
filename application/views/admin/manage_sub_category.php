...
<head>
   <meta charset="UTF-8">
   <title>TBTayo! | Manage Blog Sub Category</title>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="main-header">
                  <h4>📚 Manage Blog Sub Categories</h4>
               </div>
            </div>
                                 ...
                                 <tbody>
                                    <?php if (count($viewdetails)):
                                       ...
                                       foreach ($viewdetails as $row): ?>
                                          <tr>
                                             <td><?php echo $cnt++; ?></td>
                                             <td class="text-start"><?php echo htmlspecialchars($row->subcategory_name); ?>
                                             </td>
                                             <td class="text-start"><?php echo htmlspecialchars($row->name); ?></td>
                                             <td>
                                                <a href="<?php echo site_url("admin/Category/subdelete/{$row->id}"); ?>"

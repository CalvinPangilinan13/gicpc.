...
<head>
   ...
   <title>TBTayo! | Update Blog Post</title>
            ...
            <div class="row">
               <div class="col-md-6 form-section">
                  ...
                  <input class="form-control" type="text" name="title" id="title"
                     value="<?php echo $editdata->newtitle; ?>" />
               ...
               <div class="col-md-6 form-section">
                  ...
                  <select class="form-control" name="category" id="category">
                     <option value="<?php echo $editdata->idcate; ?>"><?php echo $editdata->category; ?></option>
               ...
               <div class="col-md-6 form-section">
                  ...
                  <select class="form-control" name="subcategory" id="subcategory" required>
                     <option value="<?php echo $editdata->subcat; ?>"><?php echo $editdata->subcategory; ?></option>
                  </select>
               </div>
               ...
               <div class="col-md-6 form-section">
                  ...
                  <?php if ($editdata->Upload_Image != ""): ?>
                     <img class="img-preview" src="<?php echo base_url('uploads/files/' . $editdata->Upload_Image); ?>"
                        alt="Current Image">
                  <?php else: ?>
                     <img class="img-preview" src="<?php echo base_url('images/default.png'); ?>" alt="Default Image">
                  <?php endif; ?>
               </div>
               ...
               <div class="col-md-12 form-section">
                  ...
                  <textarea name="description" id="description" class="form-control"
                     rows="6"><?php echo $editdata->Description; ?></textarea>
               </div>
